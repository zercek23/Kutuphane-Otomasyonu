...
namespace Veritabanı_Proje
{
    public partial class PersonelListe : Form
    {
        ...
        {
            baglanti.Open();
            string kayit = "SELECT * FROM Kullanici where kullaniciTur = 'personel'";
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            string kayit1 = "update IletisimBilgileri set telefon=@telefon,adres=@adres,eposta=@eposta,ilNo=@ilNo,ilceNo=@ilceNo where iletisimNo ='"+iletisimNo+"'";
